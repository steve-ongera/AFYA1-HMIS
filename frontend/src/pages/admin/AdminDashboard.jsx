...
import { dashboardAPI, usersAPI, patientsAPI, admissionsAPI, assetsAPI } from '../../services/api'
                ...
                <tbody>
                  {recentUsers.map((user) => (
                    <tr key={user.id}>
                      ...
                      <td>{user.is_active ? <span className="badge badge-success">Active</span> : <span className="badge badge-danger">Inactive</span>}</td>
                      <td><button className="btn btn-sm btn-ghost" onClick={() => navigate(`/admin/users/${user.id}`)}>Edit</button></td>
                    </tr>
                  ))}
                </tbody>
              </table>
                ...
                <tbody>
                  {recentPatients.map((patient) => (
                    <tr key={patient.id}>
                      ...
                      <td><button className="btn btn-sm btn-ghost" onClick={() => navigate(`/shared/patient/${patient.id}`)}>View</button></td>
                    </tr>
                  ))}
                </tbody>
              </table>
